		...
		if (!sessionCheck()) {
			...
			if ($_POST['hdnCmd'] == "Add") {
				...
				if ($res) {
					...
					$e = oci_error($stid);
					echo "Error Adding search table record: please verify the input is properly formatted [" . $e['message'] . "]";
				}		
			}
			...
			if ($_GET['Action'] == "Del") {
				...
				if ($res) {
					...
					$e = oci_error($stid);
					echo "Error Deleting search table record [" . $e['message'] . "]";
				}		
...
?>
				...
				if ($res) {
					...
					$e = oci_error($stid);
					echo "Error selecting table data [" . $e['message'] . "]";
				}
